<?php
  ...
  class TestEsdPerson extends UnitTestCase {
    ...
    function testGetSchoolId() {
      ...
      $person->academic_career = "PUBH";
      $this->assertEqual("rollins", $person->getSchoolId(), "getSchool should return 'rollins' for acadamic career 'PUBH'; got '" . $person->getSchoolId() . "'");
    }
  }

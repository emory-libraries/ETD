...
XForm.preInitialise = function(){};
XForm.postInitialise = function(){};
//XForm.preInitialiseEvent  = new YAHOO.util.CustomEvent("preInitialiseEvent");
//XForm.postInitialiseEvent = new YAHOO.util.CustomEvent("postInitialiseEvent");
...
XForm.initialize = function() {
  ...
  // function calls. It also resets the browser timeouts.
    ...
    function Phase4() {
      XForm.preInitialise();
//      XmlEvent.dispatch(document.documentElement, "XForms-preinitialise");
      xform.render();
      setTimeout(function(){}, 0); 
      XForm.postInitialise();
//      XmlEvent.dispatch(document.documentElement, "XForms-postinitialise");
...
XForm.prototype.renderBody = function() {
  ...
  for (var i = htmlBody.childNodes.length - 1; i >= 0; --i) {
    ...
    if (htmlBody.childNodes.item(i).id == "aflaxcontrol") {
      continue;
    }

...
class Zend_Http_Client
{
    ...
    public static function encodeFormData($boundary, $name, $value, $filename = null, $headers = array()) {
      ...
      // NOTE: this type of array notation is PHP-specific and should NOT be used when posting
      //  - could not fix by extending because this is a static function & PHP only supports
      //    late static bindings in 5.3
      // 2009.11.17 RSK

...
class programs extends XmlObject {
  //class programs extends skosCollection {
  ...
  // reference to parent collection (if not root)
  public $parent;
  ...
  public function __construct($dom, $id = "#programs") {
	...
	"id" => array("xpath" => "rdf:about"), 
	"label" => array("xpath" => "rdfs:label"), 

	//			  "is_series" => true, "class_name" => "skosCollection"),
	"members" => array("xpath" => "skos:Collection[@rdf:about = '#programs']/skos:member",
			   "is_series" => true, "class_name" => "skosMember"),

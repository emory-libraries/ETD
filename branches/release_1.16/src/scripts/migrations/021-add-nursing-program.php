...
// programs
$program_data = array(
  // NURS - Neil Hodgson Woodruff School of Nursing
  array("id"=>'nursing', "label"=>'Neil Hodgson Woodruff School of Nursing'),
  array("level01"=>'nursing', "id"=>'nhwson-dnp', "label"=>'Doctor of Nursing Practice'),
);

...
class TestEtdFile extends UnitTestCase {
  ...
  public function testInitFromFile() {
    ...
    // NOTE: using custom mappings of dc:format fields
    ...
    $this->assertEqual("8", $etdfile->dc->pages);	// p. stripped off when accessed via ->pages
    $this->assertPattern("|<dc:format>8 p.</dc:format>|", $etdfile->dc->saveXML());

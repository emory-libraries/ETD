...
/* bypass because routes aren't defined */
/*class TestEtd_Controller_Action_Helper_Url extends Zend_Controller_Action_Helper_Abstract {
  // build a rough simulation of what the url should be...
  public function direct($action, $controller = null, $module = null, array $params = null) {
    $url = "/";
    if (!is_null($module)) $url .= $module . "/";
    if (!is_null($controller)) $url .= $controller . "/";
    $url .= $action;
